...
{
    return [NBQRCodeTool NBGenerateWithDefaultQRCodeData:sData imageWidth:200 red:0 green:0 blue:0];
}

/** 生成一张指定图片尺寸的二维码 默认颜色黑色*/
+ (UIImage *)NBGenerateWithDefaultQRCodeData:(NSString *)sData imageWidth:(CGFloat)Imagewidth
{
 return [NBQRCodeTool NBGenerateWithDefaultQRCodeData:sData imageWidth:Imagewidth red:0 green:0 blue:0];
}

/** 生成一张指定颜色的二维码 图片默认尺寸200 * 200 pix*/
+ (UIImage *)NBGenerateWithDefaultQRCodeData:(NSString *)sData red:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue
{
    return [NBQRCodeTool NBGenerateWithDefaultQRCodeData:sData imageWidth:200 red:red green:green blue:blue];
}
                                      ...
                                      blue:(CGFloat)blue
{
    ...
    // 5、上色
    return [NBQRCodeTool imageBlackToTransParent:scaleImage withRed:red andGreen:green andBlur:blue];
...
+ (UIImage *)NBGenerateWithLogoQRCodeData:(NSString *)sData logoImageName:(NSString *)logoName{


    return [NBQRCodeTool NBGenerateWithLogoQRCodeData:sData imageWidth:200 logoImageName:logoName logoScale:0.2];
}


/** 生成一张带指定尺寸logo的二维码 默认颜色黑色,logo默认比例长宽为图片的0.2*/
+ (UIImage *)NBGenerateWithLogoQRCodeData:(NSString *)sData imageWidth:(CGFloat)Imagewidth logoImageName:(NSString *)logoName
{

    return [NBQRCodeTool NBGenerateWithLogoQRCodeData:sData imageWidth:Imagewidth logoImageName:logoName logoScale:0.2];
...
+ (UIImage *)NBGenerateWithLogoQRCodeData:(NSString *)sData
    ...
    return [NBQRCodeTool NBGenerateWithLogoQRCodeData:sData imageWidth:Imagewidth logoImageName:logoName logoScale:scale red:0 green:0 blue:0];
...
+ (UIImage *)NBGenerateWithLogoQRCodeData:(NSString *)sData
    ...
    // 5、改变颜色
    UIImage *start_image = [NBQRCodeTool imageBlackToTransParent:scale_image withRed:red andGreen:green andBlur:blue];
    ...
    icon_image = [icon_image roundedRectWith:icon_image.size.width * 0.2 cornerMask:UIImageRoundedCornerTopLeft|UIImageRoundedCornerTopRight|UIImageRoundedCornerBottomLeft|UIImageRoundedCornerBottomRight];
 ...
 */
+ (UIImage *)NBGenerateWithLogoQRCodeData:(NSString *)data logoImageName:(NSString *)logoImageName logoScaleToSuperView:(CGFloat)logoScaleToSuperView {
    // 1、创建滤镜对象
    CIFilter *filter = [CIFilter filterWithName:@"CIQRCodeGenerator"];
